...
var _ OAuthSessionStore = (*mockOAuthSessionStore)(nil)
var _ OAuthCompletionHandler = (*mockOAuthCompletionHandler)(nil)
...
func TestInterfaceCompliance(t *testing.T) {
	// This test verifies that mocks implement the interfaces
	// If this compiles, the interfaces are defined correctly
	var provider OAuthProvider = &mockOAuthProvider{}
	var store OAuthSessionStore = &mockOAuthSessionStore{}
	var handler OAuthCompletionHandler = &mockOAuthCompletionHandler{}

	// Use the variables to avoid "declared but not used" errors
	_ = provider
	_ = store
	_ = handler
}
