  ...
  return [
    {
      ...
      quota_snapshots: {
        premium_interactions: {
	      ...
	      session_quota: {
	        window_start_utc: new Date(Date.now() - 60 * 60 * 1000).toISOString(),
	        window_end_utc: new Date(Date.now() + 4 * 60 * 60 * 1000).toISOString(),
	        minute_window_start_utc: new Date(Date.now() - 20 * 1000).toISOString(),
	        minute_window_end_utc: new Date(Date.now() + 40 * 1000).toISOString(),
	        requests_per_minute: 5,
	        requests_this_minute: 2,
	        remaining_this_minute: 3,
	        requests_per_session: 50,
	        requests_this_session: 11,
	        remaining_this_session: 39,
	        first_initiator_used: true,
	      },
    },
    {
      credential_id: 'cred-copilot-002',
      ...
      quota_snapshots: {
        premium_interactions: {
	      ...
	      session_quota: {
	        window_start_utc: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
	        window_end_utc: new Date(Date.now() + 3 * 60 * 60 * 1000).toISOString(),
	        minute_window_start_utc: new Date(Date.now() - 35 * 1000).toISOString(),
	        minute_window_end_utc: new Date(Date.now() + 25 * 1000).toISOString(),
	        requests_per_minute: 5,
	        requests_this_minute: 5,
	        remaining_this_minute: 0,
	        requests_per_session: 50,
	        requests_this_session: 34,
	        remaining_this_session: 16,
	        first_initiator_used: true,
	      },
    },
  ];
